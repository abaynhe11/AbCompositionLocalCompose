package com.google.firebase.quickstart.auth.abcompositionlocalcompose
...
import com.google.firebase.quickstart.auth.abcompositionlocalcompose.ui.theme.AbCompositionLocalComposeTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            AbCompositionLocalComposeTheme {
